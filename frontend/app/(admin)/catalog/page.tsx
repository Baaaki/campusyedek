                                ...
                                <tbody>
                                  {semesterCourses.mandatory.map((course) => (
                                    ...
                                    >
                                      ...
                                      <td className="px-3 py-2 text-center text-gray-600">{course.practical_hours}</td>
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl p-5">
                ...
                <div className="grid grid-cols-5 gap-3">
                  ...
                  <div className="text-center p-3 bg-white rounded-lg border border-blue-100">
                    <div className="text-2xl font-bold text-blue-600">{selectedCourse.practical_hours}</div>
